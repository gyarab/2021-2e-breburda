...
//    }
    ...
    public int getProficiency(String type, boolean isProficient) {
        return characterClass.getProficiency(type) && isProficient ? (int) (Math.ceil(level / 4.0) + 1) : 0;
    }
...
//    }
    ...
    public Attack getStrength(String name) throws Exception {
        for (Check c : checks) {
